...
/**
 * Provides an authentication context by rendering an auth provider with the error toast handler injected, forwarding remaining configuration and rendering `children` inside it.
 *
