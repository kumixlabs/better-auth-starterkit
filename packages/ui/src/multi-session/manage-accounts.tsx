...
import { ItemGroup, ItemSeparator } from "@kumix/ui/ui/item";
import { cn } from "@kumix/utils";
import { multiSessionPlugin } from "../lib/multi-session-plugin";
...
export function ManageAccounts({ className }: ManageAccountsProps) {
  ...
  return (
    <div>
      <h2 className="mb-3 font-semibold text-sm">{multiSessionLocalization.manageAccounts}</h2>
