...
import { Avatar, AvatarFallback, AvatarImage } from "@kumix/ui/ui/avatar";
      ...
      <CardHeader className="gap-4">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            {client?.client_uri ? (
              <p className="truncate text-muted-foreground text-xs">{client.client_uri}</p>
            ) : null}
          </div>
        </div>
              ...
              (deviceSession: ListDeviceSession<OAuthProviderMultiSessionAuthClient>) => {
                ...
                return (
                  <Item key={deviceSession.session.id} variant="outline">
                    ...
                    <ItemActions>
                      {isCurrent && (
                        <Badge variant="secondary">{localization.currentAccount}</Badge>
                      )}
