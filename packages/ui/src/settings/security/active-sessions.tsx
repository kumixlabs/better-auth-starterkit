...
import { Item, ItemContent, ItemGroup, ItemMedia, ItemSeparator } from "@kumix/ui/ui/item";
...
export function ActiveSessions({ className }: ActiveSessionsProps) {
  ...
  return (
    <div>
      <h2 className="mb-3 font-semibold text-sm">{localization.settings.activeSessions}</h2>
